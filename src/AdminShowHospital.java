...
public class AdminShowHospital extends JFrame {
	 ...
	 * Create the frame.
	 */
	public AdminShowHospital(ArrayList<Hospital>hospital,ArrayList<DiagnosticCenter> diagnostic, int i) {
		hfile = new File("Hospital.txt");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 961, 692);
		...
		scrollPane.setBounds(260, 466, 637, 43);
		...
		dateChooser.setBounds(0, 466, 106, 43);
		...
		txtSeeAParticular.setBounds(0, 429, 205, 27);
		...
		txtAddAParrticular.setBounds(0, 519, 211, 27);
		contentPane.add(txtAddAParrticular);

		JDateChooser dateChooser_1 = new JDateChooser();
		dateChooser_1.setBounds(0, 568, 106, 43);
		...
		btnNewButton.setBounds(796, 568, 101, 43);
		contentPane.add(btnNewButton);

		JScrollPane scrollPane_1 = new JScrollPane();
		scrollPane_1.setBounds(133, 568, 637, 43);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AdminShowHospital.this.dispose();
		...
		btnShowInfo.setBounds(118, 466, 121, 43);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AdminShowHospital.this.dispose();
				new AdminHospitalAllDateInfo(hospital,diagnostic,i).setVisible(true);;
			}
		});
		btnNewButton_2.setFont(new Font("Tahoma", Font.PLAIN, 17));
		btnNewButton_2.setBounds(0, 370, 259, 49);
