...
public class AddingHospital extends JFrame {
	...
	public AddingHospital(ArrayList<Hospital> hospital, ArrayList<DiagnosticCenter> diagnostic) {
		...
		contentPane_1.setBackground(new Color(0, 51, 51));
		...
		JButton btnNewButton_2_1 = new JButton("Main Menu");
		...
		btnNewButton_2_1.setBounds(568, 653, 133, 35);
